...
const RobotControl = ({ routeToEdit, onFinishEditing }) => {
    ...
    useEffect(() => {
        ...
        const movesRef = ref(db, `routes1/${currentRouteId}/moves`);
    ...
    const handleStartMove = (direction) => {
        ...
        if (moveBeingReplaced) {
            const moveRef = ref(db, `routes1/${currentRouteId}/moves/${moveBeingReplaced}`);
    ...
    const handleStopMove = () => {
        ...
        const moveRef = ref(db, `routes1/${currentRouteId}/moves/${activeMoveKey}`);
    ...
    const handleStartSession = () => {
        ...
        const newRouteRef = push(ref(db, 'routes1'));
